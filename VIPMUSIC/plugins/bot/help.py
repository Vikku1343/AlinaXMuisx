...
async def about_callback(client: Client, callback_query: CallbackQuery):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="🎁ɪɴsᴛᴀ🎁", url=f"https://t.me/Dilll_Se"),
            InlineKeyboardButton(text="💲ʏᴏᴜᴛᴜʙᴇ💲", url=f"https://t.me/Ishq_Sukoon"),
        ],
        [
